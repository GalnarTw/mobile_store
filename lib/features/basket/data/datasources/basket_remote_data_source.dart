...
class BasketRemoteDataSourceImpl implements BasketRemoteDataSource {
  ...
  // @override
  // Future<List<Basket>> searchBasket() async {
  //   List<Basket> lisar = [await retrofitApi.toBasket()];
  //   return lisar;
  // }
  @override
  Future<List<Three>> searchThree() async {
    List<Three> lisakl = [await retrofitApi.toBasket()];
    return lisakl;
  }
}
